module Authlogic
  module TestHelpers
    ...
    # Sets the session for a record. This way when you execute
    # a request in your test, session values will be present.
    ...
    # Sets the cookie for a record. This way when you execute
    # a request in your test, cookie values will be present.
    ...
    # Sets the HTTP_AUTHORIZATION header for basic HTTP auth.
    # This way when you execute a request in your test that is trying to authenticate
